...
async function main() {
    ...
    const contractAddressOfCaller = await deployContract(vm,accountPk,CALLER_CONTRACT_BYTECODE,INITIAL_GREETING)

    const contractAddressOfReceiver = await deployContract(vm,accountPk,RECEIVED_CONTRACT_BYTECODE,INITIAL_GREETING)


    console.log('Contract address => ', contractAddressOfCaller.toString())
