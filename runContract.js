...
//   console.log('Block is ',block.header.stateRoot)


    // await vm.runBlock({block,root:await vm.stateManager.getStateRoot()}).then(console.log).catch(e=>console.log('Error occured ',e))
